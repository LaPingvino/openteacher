// Package javascriptpercentscalculator provides functionality ported from Python module
//
...
func NewPercentsCalculatorModule() *PercentsCalculatorModule {
	base := core.NewBaseModule("logic", "javascriptpercentscalculator-module")
