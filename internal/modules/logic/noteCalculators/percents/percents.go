...
// legacy/modules/org/openteacher/logic/noteCalculators/percents/percents.py
//
...
func (per *PercentsNoteCalculatorModule) format() {
	// TODO: Port Python private method logic
}

// CalculateNote is the Go port of the Python calculateNote method
func (per *PercentsNoteCalculatorModule) CalculateNote() {
	// TODO: Port Python method logic
}

// CalculateAverageNote is the Go port of the Python calculateAverageNote method
func (per *PercentsNoteCalculatorModule) CalculateAverageNote() {
	// TODO: Port Python method logic
}
...
// _format is the Go port of the Python _format function
func _format() {
	// TODO: Port Python function logic
}
