// Package randomtest.go provides functionality ported from Python module
// legacy/modules/org/openteacher/logic/listModifiers/randomTest/randomTest.py
//
...
// TestRandom is the Go port of the Python testRandom method
func (tes *TestCase) TestRandom() {
...
// TestRandom is the Go port of the Python testRandom function
