// Package sorttest.go provides functionality ported from Python module
// legacy/modules/org/openteacher/logic/listModifiers/sortTest/sortTest.py
//
...
// TestSort is the Go port of the Python testSort method
func (tes *TestCase) TestSort() {
...
// TestSort is the Go port of the Python testSort function
