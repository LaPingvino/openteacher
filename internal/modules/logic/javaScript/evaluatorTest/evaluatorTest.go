// Package evaluatortest.go provides functionality ported from Python module
// legacy/modules/org/openteacher/logic/javaScript/evaluatorTest/evaluatorTest.py
//
...
func NewTestModule() *TestModule {
	base := core.NewBaseModule("testSuite", "testSuite")
