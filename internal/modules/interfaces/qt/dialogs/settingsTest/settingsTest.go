// Package settingstest.go provides functionality ported from Python module
// legacy/modules/org/openteacher/interfaces/qt/dialogs/settingsTest/settingsTest.py
//
...
// TestSettingsDialog is the Go port of the Python testSettingsDialog method
func (tes *TestCase) TestSettingsDialog() {
...
// TestSettingsDialog is the Go port of the Python testSettingsDialog function
