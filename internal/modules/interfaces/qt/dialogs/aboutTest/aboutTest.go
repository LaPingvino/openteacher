// Package abouttest.go provides functionality ported from Python module
// legacy/modules/org/openteacher/interfaces/qt/dialogs/aboutTest/aboutTest.py
//
...
// TestShowingAboutDialog is the Go port of the Python testShowingAboutDialog method
func (tes *TestCase) TestShowingAboutDialog() {
...
// TestShowingAboutDialog is the Go port of the Python testShowingAboutDialog function
