// Package topotest.go provides functionality ported from Python module
// legacy/modules/org/openteacher/interfaces/qt/teachers/topoTest/topoTest.py
//
...
// TestCreateTopoTeacher is the Go port of the Python testCreateTopoTeacher method
func (tes *TestCase) TestCreateTopoTeacher() {
...
// TestCreateTopoTeacher is the Go port of the Python testCreateTopoTeacher function
