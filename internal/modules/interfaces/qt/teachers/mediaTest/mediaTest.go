...
// legacy/modules/org/openteacher/interfaces/qt/teachers/mediaTest/mediaTest.py
//
...
// TestCreateMediaTeacher is the Go port of the Python testCreateMediaTeacher method
func (tes *TestCase) TestCreateMediaTeacher() {
...
// TestCreateMediaTeacher is the Go port of the Python testCreateMediaTeacher function
