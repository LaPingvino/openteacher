// Package qtapptest.go provides functionality ported from Python module
// legacy/modules/org/openteacher/interfaces/qt/qtAppTest/qtAppTest.py
//
...
// TestForQApplication is the Go port of the Python testForQApplication method
func (tes *TestCase) TestForQApplication() {
...
// TestForQApplication is the Go port of the Python testForQApplication function
