// Package shorttext.go provides functionality ported from Python module
// legacy/modules/org/openteacher/interfaces/qt/settingsWidget/shortText/shortText.py
//
