...
// legacy/modules/org/openteacher/interfaces/qt/enterers/wordsTest/wordsTest.py
//
...
// TestCreateWordsEnterer is the Go port of the Python testCreateWordsEnterer method
func (tes *TestCase) TestCreateWordsEnterer() {
...
// TestCreateWordsEnterer is the Go port of the Python testCreateWordsEnterer function
