...
// legacy/modules/org/openteacher/interfaces/qt/enterers/topoTest/topoTest.py
//
...
// TestCreateTopoEnterer is the Go port of the Python testCreateTopoEnterer method
func (tes *TestCase) TestCreateTopoEnterer() {
...
// TestCreateTopoEnterer is the Go port of the Python testCreateTopoEnterer function
