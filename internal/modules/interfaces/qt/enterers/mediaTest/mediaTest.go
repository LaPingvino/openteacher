...
// legacy/modules/org/openteacher/interfaces/qt/enterers/mediaTest/mediaTest.py
//
...
// TestCreateMediaEnterer is the Go port of the Python testCreateMediaEnterer method
func (tes *TestCase) TestCreateMediaEnterer() {
...
// TestCreateMediaEnterer is the Go port of the Python testCreateMediaEnterer function
