// Package guitest.go provides functionality ported from Python module
// legacy/modules/org/openteacher/interfaces/qt/guiTest/guiTest.py
//
...
// TestSize is the Go port of the Python testSize method
func (tes *TestCase) TestSize() {
...
// TestSize is the Go port of the Python testSize function
