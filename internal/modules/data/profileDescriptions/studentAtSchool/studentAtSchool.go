// Package studentatschool provides functionality ported from Python module
//
// This is an automated port - implementation may be incomplete.
package studentatschool
...
func NewProfileDescriptionModule() *ProfileDescriptionModule {
	base := core.NewBaseModule("data", "studentatschool-module")
...
func (mod *ProfileDescriptionModule) retranslate() {
