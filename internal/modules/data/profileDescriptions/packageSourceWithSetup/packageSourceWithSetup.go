// Package packagesourcewithsetup provides functionality ported from Python module
//
// This is an automated port - implementation may be incomplete.
package packagesourcewithsetup
...
func NewProfileDescriptionModule() *ProfileDescriptionModule {
	base := core.NewBaseModule("data", "packagesourcewithsetup-module")
