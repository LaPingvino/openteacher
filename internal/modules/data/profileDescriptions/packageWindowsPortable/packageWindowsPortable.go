// Package packagewindowsportable provides functionality ported from Python module
//
// This is an automated port - implementation may be incomplete.
package packagewindowsportable
...
func NewProfileDescriptionModule() *ProfileDescriptionModule {
	base := core.NewBaseModule("data", "packagewindowsportable-module")
